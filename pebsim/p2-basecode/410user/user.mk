...
STUU_C0_OBJS := $(C0_OBJS:%=$(STUUDIR)/libc0/%)
ALL_STUUOBJS += $(STUU_C0_OBJS)
STUUCLEANS += $(STUUDIR)/libc0.a
$(STUUDIR)/libc0.a: $(STUU_C0_OBJS)

STUU_C0CONCUR_OBJS := $(C0CONCUR_OBJS:%=$(STUUDIR)/libc0concur/%)
ALL_STUUOBJS += $(STUU_C0CONCUR_OBJS)
STUUCLEANS += $(STUUDIR)/libc0concur.a
$(STUUDIR)/libc0concur.a: $(STUU_C0CONCUR_OBJS)
